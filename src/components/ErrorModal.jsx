...
const ErrorModal = ({ isOpen, onClose, errorType, customMessage }) => {
  ...
  const errorMessages = {
    "file-upload":
      "Error al subir los archivos. Verifica que los archivos sean válidos y no excedan el tamaño permitido.",
    "email-invalid":
    ...
    "file-type":
      "Tipo de archivo no permitido. Solo se aceptan documentos: PDF, Word, TXT, Excel, JPG y PNG.",
    "file-size":
  ...
  return (
    <div className="error-modal-overlay">
      ...
      <div className="error-modal-container">
        <div
          className={`icon-container ${isSuccess ? "success-icon-container" : "error-icon-container"}`}
        >
          {isSuccess ? (
            <svg
        ...
        <h3 className="error-title">
          {" "}
          {isSuccess ? "¡Éxito!" : "Algo no se ve bien"}{" "}
        </h3>
